...
import { MessageSquare, UserPlus, UserCheck, ShieldCheck, Loader2, Search } from 'lucide-react';
              ...
              <Card key={user.id} className="border-none shadow-sm hover:shadow-md transition-all group">
                <CardContent className="p-5 flex flex-col gap-4">
                  <div className="flex items-center gap-4">
                    <Avatar className="h-14 w-14 ring-2 ring-primary/5 transition-transform group-hover:scale-105">
                  ...
                  <div className="flex gap-2">
                    {isMutual ? (
                      <Link href={`/messages/chat/${user.id}`} className="flex-1">
                        <Button className="w-full h-10 gap-2 font-bold bg-green-600 hover:bg-green-700">
