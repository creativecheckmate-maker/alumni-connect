...
/**
 * NexusShell - Independent Server Component Shell
 * This component handles all site configuration fetching and 
 * wraps children in the interactive MainClientShell.
 * 
 * By moving this logic out of the (main) route group, we prevent 
 * Next.js build manifest collisions on Vercel.
 */
...
export async function NexusShell({
  children,
}: {
